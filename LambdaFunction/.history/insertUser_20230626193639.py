...
def lambda_handler(event, context):
    ...
    try:
        ...
        # Recupera i valori specifici che desideri inserire nella tabella DynamoDB
        #qui oltre che l'access key id teoricamente non serve nulla
        ...
        #gestione errore nel recupero dei dati da body
