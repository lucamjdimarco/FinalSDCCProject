...
app.config['AWS_ACCESS_KEY'] = None
app.config['AWS_SESSION_TOKEN'] = None
...
def login():
    ...
    if request.method == 'POST':
        ...
        if authenticated:
            app.config['AWS_ACCESS_KEY_ID'] = request.form['aws_accesskey_id']
            app.config['AWS_ACCESS_KEY'] = request.form['aws_accesskey']
            app.config['AWS_SESSION_TOKEN'] = request.form['aws_session_token']
