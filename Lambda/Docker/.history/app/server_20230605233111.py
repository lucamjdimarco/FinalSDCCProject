...
def login():
    ...
    if request.method == 'POST':
        ...
        authenticated = authenticate(request.form.get('aws_accesskey_id'), request.form.get('aws_accesskey'), request.form.get('aws_session_token'), request.form.get('email_address'), request.form.get('email_password'))
        if authenticated:
            ...
            s3 = boto3.client(
                's3',
                aws_access_key_id=request.form['aws_accesskey_id'],
                aws_secret_access_key=request.form['aws_accesskey'],
                aws_session_token=request.form['aws_session_token']
            )
