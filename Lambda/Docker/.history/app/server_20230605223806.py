...
app.config['ACCESS_KEY_ID'] = ''
app.config['ACCESS_KEY'] = ''
app.config['SESSION_TOKEN'] = ''
app.config['EMAIL'] = ''
app.config['PASSWEMAIL'] = ''
...
def login():
    ...
    if request.method == 'POST':
        ...
        if authenticated:
            ...
            global s3
            s3 = boto3.client('s3', aws_access_key_id=app.config['ACCESS_KEY_ID'], aws_secret_access_key=app.config['ACCESS_KEY'], aws_session_token=app.config['SESSION_TOKEN'])
